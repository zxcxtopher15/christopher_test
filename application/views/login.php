        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="<?= base_url('mycontroller/registration'); ?>">Register</a>
                    <a class="nav-link active" href="<?= base_url('mycontroller/login'); ?>">Login</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <script>
        $(document).ready(function() {
            $("#loginBtn").on("click", function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('mycontroller/loginfunction'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.status === "success") {
                            window.location.href = "<?= base_url('mycontroller/dashboard'); ?>";
                        } else {
